const main = {
  ...
  drawBlock({ text, width = 0, height, x, y, paddingLeft = 0, paddingRight = 0, borderWidth, backgroundColor, borderColor, borderRadius = 0, opacity = 1 }) {
    ...
    if (typeof text !== 'undefined') {
      ...
      // this.ctx.moveTo(178, 552);
      // this.ctx.lineTo(214, 552);
  ...
  drawText(params) {
    console.log(params)
    const { x, y, fontSize, color, baseLine, textAlign, text, opacity = 1, width, lineNum, lineHeight, textDecoration } = params;
