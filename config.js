 ...
 * sid   店铺id
 */
var isRelease = true;//婴众趣购
var host = "https://b2b.qutego.com/"
var testhost = "https://grayscale.qutego.com/"
var sid =295;
var uid = null;//不填写默认null,填写直接改uid，142750
var sid_test = '';//婴众趣购（test）
var title ='婴众';
var title_test = '婴众趣购';
...
let config = {
  ...
  sessionUrl: `wxapp.php?c=wechatapp&a=get_session_key`,

  //2、判断用户是否绑定了手机第三版
  checkBingUrl: `wxapp.php?c=wechatapp_v2&a=check_phone_v2`,

  // 判断是否填写用户信息
  isgetDetail:`wxapp.php?c=wechatapp&a=check_auth`,

  //3、如果没有绑定手机，调用小程序的授权获取手机号码
  // getPhoneUrl:`wxapp.php?c=wechatapp_v2&a=get_phone`,
  getPhoneUrl: `wxapp.php?c=wechatapp&a=get_phone`,
