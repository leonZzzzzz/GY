  ...
  getPhoneNumber(e) {
    ...
    if (e.detail.errMsg == "getPhoneNumber:ok") {
      ...
      app.login(params).then((data) => {
        ...
        that.setData({
          hasPhone: false, isInfo: false, uid: data
        }, () => {
          that.redirctPageNew();
        })
      }).catch(() => {
  ...
  buildRedirctUrlNew: function () { 
    ...
    switch (resType) {
      ...
      case 'cloud_screen': console.log('reditype', reditype, rediurl);
        // reditype栏目1 ，商品2，送券活动4，dm海报5，心选小铺首页6，
        ...
        if (reditype == "1") {
          switch (rediurl) {
            ...
            //礼包特卖模块
            case "10": url = `../../page/common/pages/hotsale?categoryid=104&page=1&store_id=${store_id}&rediurl=${rediurl}`; break;
            //拼团
            case "11": url = `../../page/group-buying/grouplist`; break;
            //增值活动
            case "12": url = `../../page/common/pages/index-mom`; break;
            // 秒杀活动
            case "13": url = `../../page/common/pages/seckill?categoryid=108`; break;
            //雅培礼包特卖
            case "14": url = `../../page/common/pages/hotsale?categoryid=104&page=1&store_id=${store_id}&rediurl=${rediurl}`; break;
            // 伊利
            case "15": url = `../../page/common/pages/hotsale?categoryid=105&page=1&store_id=${store_id}&rediurl=${rediurl}`; break;
          ...
          console.log('心选首页');
          wx.switchTab({
            url: '../../page/tabBar/shopping/shoppstore-index',
          })
        } else {
      ...
      // 扫码进入宝宝星座  
      case 'tag':
        url = '../../page/common/pages/starmap?store_id=' + app.store_id;
        break;
      //大屏大转盘领取优惠券
      case 'lottery':
        url = '../../page/common/pages/card_summary?id=' + resId + '&activityId=' + activityId + '&lotteryId=' + lotteryId + '&source=2' + '&qrEntry=1' + '&prize=' + prize;
        break;
      //商品详情页面
      case 'goods':
